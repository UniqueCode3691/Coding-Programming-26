...
const Footer = () => {
  return (
    ...
    <div className='bg-oliveleather w-full h-15 text-white text-lg flex flex-row items-center justify-between'>
        ...
        <p><Link to="/privacy-policy" className='underline'>Privacy Policy</Link> | <Link to="/terms-of-service" className='underline'>Terms of Service</Link> | <a href="https://github.com/UniqueCode3691/Coding-Programming-26" className='underline'>Help</a></p>
